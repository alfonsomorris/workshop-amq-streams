...
You can also view the Secrets in the OpenShift console:

image::images/security-01.png[Secrets]

image::images/security-02.png[secure-topic-reader Secret]
...
image::images/security-04.png[secure-topic-reader Secret]
